...
#### Rstudio 
  ...
  - [![launch @ gke.mybinder.org][badge-rstudio-gke-mybinder-org]](https://gke.mybinder.org/v2/gh/thedatasociety/lab-hadoop/master?urlpath=rstudio)

  - [![launch @ ovh.mybinder.org][badge-rstudio-ovh-mybinder-org]](https://ovh.mybinder.org/v2/gh/thedatasociety/lab-hadoop/master?urlpath=rstudio)

  - [![launch @ gesis.org][badge-rstudio-gesis-org]](https://notebooks.gesis.org/binder/v2/gh/thedatasociety/lab-hadoop/master?urlpath=rstudio)

  - [![launch @ pangeo.io][badge-rstudio-pangeo-io]](https://binder.pangeo.io/v2/gh/thedatasociety/lab-hadoop/master?urlpath=rstudio)

      
#### Shiny 
  
  - [![launch @ gke.mybinder.org][badge-shiny-gke-mybinder-org]](https://gke.mybinder.org/v2/gh/thedatasociety/lab-hadoop/master?urlpath=shiny)

  - [![launch @ ovh.mybinder.org][badge-shiny-ovh-mybinder-org]](https://ovh.mybinder.org/v2/gh/thedatasociety/lab-hadoop/master?urlpath=shiny)

  - [![launch @ gesis.org][badge-shiny-gesis-org]](https://notebooks.gesis.org/binder/v2/gh/thedatasociety/lab-hadoop/master?urlpath=shiny)

  - [![launch @ pangeo.io][badge-shiny-pangeo-io]](https://binder.pangeo.io/v2/gh/thedatasociety/lab-hadoop/master?urlpath=shiny)

      
#### Nteract 
  
  - [![launch @ gke.mybinder.org][badge-nteract-gke-mybinder-org]](https://gke.mybinder.org/v2/gh/thedatasociety/lab-hadoop/master?urlpath=nteract)

  - [![launch @ ovh.mybinder.org][badge-nteract-ovh-mybinder-org]](https://ovh.mybinder.org/v2/gh/thedatasociety/lab-hadoop/master?urlpath=nteract)

  - [![launch @ gesis.org][badge-nteract-gesis-org]](https://notebooks.gesis.org/binder/v2/gh/thedatasociety/lab-hadoop/master?urlpath=nteract)

  - [![launch @ pangeo.io][badge-nteract-pangeo-io]](https://binder.pangeo.io/v2/gh/thedatasociety/lab-hadoop/master?urlpath=nteract)


#### Stencila 
  
  - [![launch @ gke.mybinder.org][badge-stencila-gke-mybinder-org]](https://gke.mybinder.org/v2/gh/thedatasociety/lab-hadoop/master?urlpath=stencila)

  - [![launch @ ovh.mybinder.org][badge-stencila-ovh-mybinder-org]](https://ovh.mybinder.org/v2/gh/thedatasociety/lab-hadoop/master?urlpath=stencila)

  - [![launch @ gesis.org][badge-stencila-gesis-org]](https://notebooks.gesis.org/binder/v2/gh/thedatasociety/lab-hadoop/master?urlpath=stencila)

  - [![launch @ pangeo.io][badge-stencila-pangeo-io]](https://binder.pangeo.io/v2/gh/thedatasociety/lab-hadoop/master?urlpath=stencila)
